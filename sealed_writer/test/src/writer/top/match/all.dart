...
import 'test_top_match_branch_or_else_writer.dart'
    as test_top_match_branch_or_else_writer;
import 'test_top_match_branch_or_throw_writer.dart'
    as test_top_match_branch_or_throw_writer;
import 'test_top_match_branch_partial_writer.dart'
    as test_top_match_branch_partial_writer;
import 'test_top_match_branch_writer.dart' as test_top_match_branch_writer;
...
void main() {
  ...
  group('test_top_match_branch_or_else_writer',
      test_top_match_branch_or_else_writer.main);
  group('test_top_match_branch_or_throw_writer',
      test_top_match_branch_or_throw_writer.main);
  group('test_top_match_branch_partial_writer',
      test_top_match_branch_partial_writer.main);
  group('test_top_match_branch_writer', test_top_match_branch_writer.main);
