...
abstract class Result {
  ...
  void branch({
    ...
    required void Function(ResultPartialSuccess partialSuccess) partialSuccess,
    required void Function(ResultPartialError partialError) partialError,
    required void Function(ResultDoubleSuccess doubleSuccess) doubleSuccess,
  }) {
    final result = this;
    if (result is ResultSuccess) {
      success(result);
